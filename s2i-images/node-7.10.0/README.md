...
This repository contains the source for building versions 7.10.0 of
...
Usage
---------------------
To build a simple [nodejs-sample-app](https://github.com/nearform/minishift-demo/demo/) application
using standalone [S2I](https://github.com/openshift/source-to-image) and then run the
resulting image with [Docker](http://docker.io) execute:

*  **Node image**
    ```
    $ s2i build https://github.com/nearform/minishift-demo.git --context-dir=demo/server/ node nodejs-sample-app
